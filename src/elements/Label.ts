...
export default class Label extends Element<LabelParams, LabelOptions> {
    ...
    constructor(params: ElementMappable<LabelParams> | SignalMappable<string>, location?: ElementMappable<PointParams | null>) {
        if (!location) super(params as ElementMappable<LabelParams>);
        else super(() => ({
